...
testminmaxBestMove = TestCase (do
...
testfixSpotInvalidUserInput = TestCase (do
...
testfixSpotValidUserInput = TestCase (do
  let board1 = [['O', 'O', 'X'], ['X', '-', '-'], ['-', 'O', 'X']]
